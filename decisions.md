...
## 2026-07-26
- Pending confirmation: Use Telegram as a communication channel with the Infinity Power Executive Secretary for MD messages, daily-update follow-ups, and concrete assignment intake.
...
- Control required: MD must confirm that this private Telegram chat is the approved target before relying on it for routine follow-ups.
- Confirmed: MD replied "Confirm" through Telegram, approving this chat as the secretary communication target.
...
- Telegram cadence decision: check and process Telegram intake every 4 hours, and send MD a morning reminder of tasks that need follow-up.

## 2026-07-29
- MD review decision for INF-422: the updated old daily log was rechecked. The Executive Secretary is authorized to create new Paperclip tasks directly when MD messages contain concrete assignments or clear follow-up work.
- Control note: the secretary should keep using the existing task-creation rules: create a task immediately for concrete assignments, record the task ID/status in the issue or Telegram reply, and escalate ambiguous business decisions to MD instead of guessing.
